    ...
    let
        ...
        magenta =
            ...
            , reversedInteractions =
                [ HappenedBefore (tickNumber 649) NotTurning
                , HappenedBefore (tickNumber 460) TurningLeft
                , HappenedBefore (tickNumber 394) NotTurning
                , HappenedBefore (tickNumber 201) TurningRight
                ]
            }

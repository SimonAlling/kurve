module Round exposing (Kurves, OccupiedPixels, Round, RoundHistory, RoundInitialState, initialStateForReplaying, modifyAlive, modifyDead, modifyKurves, roundIsOver, scores)
...
type alias OccupiedPixels =
    { set : Set Pixel, list : List ( Pixel, Color ) }
